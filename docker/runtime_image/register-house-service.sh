...
readonly program="propertymgmt-portfoliomgmt-register-house-service"
...
readonly root=/opt/propertymgmt/portfoliomgmt/register-house-service
...
jarName=propertymgmt.portfoliomgmt.house.register-${version}.jar
