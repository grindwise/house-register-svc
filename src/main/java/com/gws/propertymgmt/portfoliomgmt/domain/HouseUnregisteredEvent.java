...
/**
 * Indicates a significant event has occurred - A house has been unregistered.
 * 
 * @author Jim Fiolek jim.fiolek@grindwise.com
 */
final class HouseUnregisteredEvent implements Event
{
    private static final transient Logger LOG = LoggerFactory.getLogger(HouseUnregisteredEvent.class);
     ...
     */
    HouseUnregisteredEvent(final AggregateRootObjectIDInformation aggregateRootObjectIDInformation,
    ...
    /**
     * Fire an event to notify of significant event.
     */
    @Override
    public void publish()
    {
