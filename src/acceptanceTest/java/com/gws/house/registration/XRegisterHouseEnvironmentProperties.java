 ...
 */
public final class XRegisterHouseEnvironmentProperties //implements RuntimeEnvironmentProperties
{
...
//    
//    private static final Logger LOG = LoggerFactory.getLogger(XRegisterHouseEnvironmentProperties.class);
//    
//    // messages
//    private static final String INVALID_NAME =
//        "The process property name cannot be null or empty.";
...
//     * Constructor.
//     */
//    public XRegisterHouseEnvironmentProperties()
//    {
//        LOG.trace("entry");
//        
...
//            System.getenv(PERSISTENT_COLLECTION_NAME_ENV_VAR);
//
//        this.validate(persistentStoreName, persistentStoreUserName,
//            persistentStoreHost, persistentStorePort, persistentCollectionName);
//        
//        this.addPropertiesToCollection(persistentStoreName,
//            persistentStoreUserName, persistentStorePassword, persistentStoreHost,
//            persistentStorePort, persistentCollectionName);
//        
//        LOG.trace("exit");
//    }
//
...
//                          final String persistentStoreHost,
//                          final String persistentStorePort,
//                          final String persistenceCollectionName)
//    {
//        LOG.trace("entry");
//        
...
//        Preconditions.checkNotNull(persistenceCollectionName, INVALID_PERSISTENT_COLLECTION_NAME);
//        Preconditions.checkArgument(!"".equals(persistenceCollectionName), INVALID_PERSISTENT_COLLECTION_NAME);
//        
